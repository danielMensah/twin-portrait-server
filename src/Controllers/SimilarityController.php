...
class SimilarityController {
    ...
    public function advancedSimilaritySearch($item, $arrayOfLandmarks) {
        ...
        $percentageEB = self::similarityCalculator($arrayOfLandmarks['eyebrows'], $eyebrows);
        $percentageEYE = self::similarityCalculator($arrayOfLandmarks['eye'], $eyes);
        $percentageNOSE = self::similarityCalculator($arrayOfLandmarks['nose'], $nose);
     ...
     * @return string
     */
    public function generateSimilarityCriteria($arrayOfLandmarks, $relevance, $beard, $mustache) {
        $criteria = "";
